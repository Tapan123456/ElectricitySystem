...
// Name
  ...
  // contact details    
        ...
        JLabel Members=new JLabel("No of Family Members :");
        JTextField Tmembers=new JTextField(10); 

        JLabel Adhaar=new JLabel("Adhaar No:");
        JTextField Tadhaar =new JTextField(20);
  ...
  //User type    
        ...
        String utype[]={"","Home_User","Private","Public"};        
  ...
  //add
	...
	add(Tname); 
      ...
      Adhaar.setBounds(100,278,150,20);
      Tadhaar.setBounds(250,278,150,20);
      Members.setBounds(100,300,200,20);
      Tmembers.setBounds(310,300,150,20);

      New.setBounds(50,340,100,20);
      Save.setBounds(200,340,100,20);
      Finish.setBounds(350,340,100,20);
